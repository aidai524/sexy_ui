...
export default function StepAction({
    ...
    if (!isMobile && step === 4) {
        return <div className={styles.btnWapper4Pc}>
            <MainBtn isDisabled={disabled} style={{ color: '#fff', backgroundColor: 'transparent', border: '1px solid #FBCA04', fontWeight: 500, height: '40px', fontSize: '14px', width: isMobile ? '100%' : '160px' }} isLoading={isLoading} onClick={onNext}>Skip</MainBtn>
