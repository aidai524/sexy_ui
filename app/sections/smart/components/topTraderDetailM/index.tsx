...
import { LeftBackIcon, ShareIcon, CopyierIconWithBg, RightTopArrowIcon, TopTraderCrown, CopierTextIcon, Performance } from '@/app/sections/trends/components/top-traders/icons'
