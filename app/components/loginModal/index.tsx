...
function LoginBox({ onHide }: any) {
    ...
    return <div className={styles.main}>
        <div className={styles.tipBox}>
            ...
            <div className={styles.tipText}>Many functions need to be
                connected to the wallet before they can be used and can participate in our mining activities</div>
        </div>

        <MainBtn isLoading={isLoading} onClick={async () => {
            setVisible(true)
        }} style={{ marginTop: 20, background: '#000', border: '1px solid #fff' }}>Connect Wallet</MainBtn>
        <div onClick={() => {
            onHide && onHide()
