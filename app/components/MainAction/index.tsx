...
export default function MainAction({
    ...
    return <div className={styles.mainAction}>
        ...
        }} className={[styles.actionIcon, hateTicked ? styles.hate : ''].join(' ')}>
