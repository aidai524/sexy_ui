...
export default function Boost({ onClick, token }: { onClick: () => void; token: Project }) {
    ...
    return <div onClick={() => {
        ...
        {
            token.boostTime && Number(token.boostTime) > 0 ? <svg width="36" height="36" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
